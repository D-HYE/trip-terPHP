<ul id="quick" class="pc">
      <li><a href="#none"><span>MY</span>
        FEEL:TER</a></li>
      <li><a href="#none">큐알이미지</a></li>
      <li><a href="#none">TOP</a></li>
    </ul>

    <footer id="ft">
        <div class="ftcontainer">
            <img src="https://trip-ter.vercel.app/img/logo/logo_TRT_basic.svg" class="ftlogo">
            <div>
    ...
    <script src="https://trip-ter.vercel.app/js/mainScript.js"></script>
